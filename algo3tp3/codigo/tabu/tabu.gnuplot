...
plot \
	...
	'complex.data' using 1:4 with lines ls 6 title '3*F(3)*n^5', \
	'complex.data' using 1:3 with lines ls 5 title '2*F(2)*n^5', \
	'complex.data' using 1:2 with lines ls 4 title 'F(1)*n^5', \
	'tabu3.data' using 1:2 with lines ls 9 title '', \
	'tabu2.data' using 1:2 with lines ls 8 title '', \
	'tabu1.data' using 1:2 with lines ls 7 title '', \
	'tabu3.data' using 1:2:3:4 with yerrorbars ls 3 title 'tabu V = 3', \
	'tabu2.data' using 1:2:3:4 with yerrorbars ls 2 title 'tabu V = 2', \
	'tabu1.data' using 1:2:3:4 with yerrorbars ls 1 title 'tabu V = 1', \
	'tabu3.data' using 1:5 with points ls 9 title '', \
	'tabu3.data' using 1:6 with points ls 12 title '', \
	'tabu2.data' using 1:5 with points ls 8 title '', \
	'tabu2.data' using 1:6 with points ls 11 title '', \
	'tabu1.data' using 1:5 with points ls 7 title '', \
	'tabu1.data' using 1:6 with points ls 10 title ''
